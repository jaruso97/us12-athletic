...
const ALL_ARTICLES = [
  ...
  {id:"l2",team:"lions",  sport:"NFL",title:"Jared Goff Signs Historic Extension, Commits to Detroit Long-Term",excerpt:"After an MVP-caliber season, Goff and the Lions agree to a franchise-defining deal that cements Detroit as a sustained contender for years to come.",author:"Marcus Johnson",time:"3h ago",readTime:"3 min",image:null,tags:["Lions","Goff"],staffPick:true,views:44100},
  {id:"l3",team:"lions",  sport:"NFL",title:"Aidan Hutchinson Fully Healthy and More Dangerous Than Ever",excerpt:"Detroit's franchise pass rusher is back at full strength after his injury and already dominating in training camp, with coaches raving about his explosiveness.",author:"Marcus Johnson",time:"5h ago",readTime:"3 min",image:null,tags:["Lions","Hutchinson"],views:28700},
  {id:"l4",team:"lions",  sport:"NFL",title:"Lions Draft Class Rated #1 by Every Major Analyst — Here's Why",excerpt:"Detroit's scouting department has quietly built one of the most complete rosters in the league, and this year's draft adds even more elite depth.",author:"Derek Williams",time:"8h ago",readTime:"4 min",image:null,tags:["Lions","NFL Draft"],views:19800},
  {id:"l5",team:"lions",  sport:"NFL",title:"Amon-Ra St. Brown: Why He's the Most Complete WR in the NFC",excerpt:"The stats back it up: routes run, yards after catch, contested catches — Detroit's No. 1 wide receiver checks every box scouts care about.",author:"Marcus Johnson",time:"1d ago",readTime:"3 min",image:null,tags:["Lions","St. Brown","WR"],views:16500},
  {id:"l6",team:"lions",  sport:"NFL",title:"Ford Field Sellout Streak Hits New Record as Lions Fever Takes Over Detroit",excerpt:"Every home game has been sold out for three straight seasons as Detroit's football renaissance transforms the city's sports culture completely.",author:"Sarah Chen",time:"1d ago",readTime:"2 min",image:null,tags:["Lions","Ford Field"],views:12300},
  ...
  {id:"t3",team:"tigers",  sport:"MLB",title:"Riley Greene Is Having the Breakout Season Tigers Fans Always Dreamed Of",excerpt:"Detroit's young outfielder is posting career numbers across the board as his blend of power and speed finally comes together at Comerica Park.",author:"Kyle Foster",time:"7h ago",readTime:"3 min",image:null,tags:["Tigers","Greene","OF"],views:24100},
  {id:"t4",team:"tigers",  sport:"MLB",title:"Comerica Park Atmosphere Hits Different This Year — And Tigers Fans Know It",excerpt:"Something has shifted in Detroit's baseball culture. The crowds are louder, the energy is electric, and the Tigers are giving fans every reason to believe.",author:"Sarah Chen",time:"10h ago",readTime:"3 min",image:null,tags:["Tigers","Comerica"],views:18600},
  {id:"t5",team:"tigers",  sport:"MLB",title:"Spencer Torkelson's Power Surge Is Exactly What Detroit Needed",excerpt:"The former top overall pick is finally living up to his draft billing with a home run pace that has Tigers fans dreaming of playoff baseball.",author:"Kyle Foster",time:"1d ago",readTime:"3 min",image:null,tags:["Tigers","Torkelson","1B"],views:15400},
  {id:"t6",team:"tigers",  sport:"MLB",title:"Tigers Bullpen Transformation: How Detroit Fixed Its Biggest Weakness",excerpt:"General manager Scott Harris has quietly assembled one of the league's most reliable relief corps, solving the issue that derailed last year's run.",author:"Marcus Johnson",time:"1d ago",readTime:"4 min",image:null,tags:["Tigers","Bullpen"],views:11200},
  ...
  {id:"p3",team:"pistons", sport:"NBA",title:"Jalen Duren Is Quietly Becoming the Best Young Center in the League",excerpt:"Detroit's big man is posting historic rebounding and rim protection numbers for a player his age, drawing comparisons to elite defensive anchors.",author:"Lisa Park",time:"9h ago",readTime:"3 min",image:null,tags:["Pistons","Duren","C"],views:22900},
  {id:"p4",team:"pistons", sport:"NBA",title:"Little Caesars Arena Playoff Energy Is Here and Detroit Can Feel It",excerpt:"The atmosphere at LCA has transformed dramatically this season as the Pistons' rise brings a new generation of Detroit basketball fans to their feet.",author:"Angela Martinez",time:"11h ago",readTime:"2 min",image:null,tags:["Pistons","LCA","Playoffs"],views:17300},
  {id:"p5",team:"pistons", sport:"NBA",title:"Ausar Thompson's Two-Way Impact Makes Pistons Lineup Near-Impossible to Guard",excerpt:"The athletic wing is disrupting opponents on defense while creating chaos in transition, giving Detroit a dimension no team in the East can match.",author:"Lisa Park",time:"1d ago",readTime:"3 min",image:null,tags:["Pistons","Thompson","SF"],views:14100},
  {id:"p6",team:"pistons", sport:"NBA",title:"Troy Weaver Built This — The Blueprint Behind Detroit's Basketball Rebirth",excerpt:"Three years ago people questioned the Pistons' rebuild. Today the picks, trades, and development decisions are paying off in spectacular fashion.",author:"Angela Martinez",time:"2d ago",readTime:"5 min",image:null,tags:["Pistons","NBA","Rebuild"],views:9800},
  ...
  {id:"rw3",team:"redwings",sport:"NHL",title:"Alex DeBrincat's 35-Goal Pace Is Exactly What Detroit Needed Up Front",excerpt:"The dynamic winger is thriving alongside Dylan Larkin in a partnership that's producing elite offensive zone possession and dangerous shot volume.",author:"Tom Bradley",time:"11h ago",readTime:"3 min",image:null,tags:["Red Wings","DeBrincat","LW"],views:16700},
  {id:"rw4",team:"redwings",sport:"NHL",title:"Lucas Raymond Cementing His Place Among NHL's Top Young Forwards",excerpt:"Detroit's Swedish forward is putting together a Norris Trophy-caliber season with all-around play that makes him one of the league's most complete players.",author:"Tom Bradley",time:"1d ago",readTime:"3 min",image:null,tags:["Red Wings","Raymond","RW"],views:13200},
  {id:"rw5",team:"redwings",sport:"NHL",title:"Red Wings Goaltending Situation Becomes a Strength After Offseason Moves",excerpt:"Detroit's crease looked like a concern heading into camp. Three months later it has become one of the team's most reliable areas.",author:"Kyle Foster",time:"1d ago",readTime:"3 min",image:null,tags:["Red Wings","Goalie"],views:10800},
  {id:"rw6",team:"redwings",sport:"NHL",title:"The Octopus is Back: Detroit Hockey Tradition Returns to LCA",excerpt:"Old-timers and new fans alike are embracing the Red Wings' rich playoff traditions as Detroit's storied franchise makes its long-awaited return to the postseason.",author:"Marcus Johnson",time:"2d ago",readTime:"2 min",image:null,tags:["Red Wings","NHL","Tradition"],views:8900},
  ...
  {id:"um3",team:"michigan",sport:"CFB",title:"Michigan's Offensive Line Rated Best in the Nation by Every Major Metric",excerpt:"The Wolverines' NFL-caliber front five is the foundation of everything — and it might be the deepest unit Ann Arbor has assembled in a generation.",author:"Kyle Foster",time:"1d ago",readTime:"3 min",image:null,tags:["Michigan","CFB","O-Line"],views:22400},
  {id:"um4",team:"michigan",sport:"CFB",title:"'The Big House' Will Be Rocking: Michigan Stadium Sells Out All Home Games",excerpt:"All seven home games at Michigan Stadium are sold out for the third consecutive year as Wolverines fever reaches a new peak across the state.",author:"Angela Martinez",time:"2d ago",readTime:"2 min",image:null,tags:["Michigan","Big House","CFB"],views:18900},
  ...
  {id:"ms2",team:"msu",    sport:"CBB",title:"Tom Izzo Masterclass: Spartans Return to Elite 8 in Another March Run",excerpt:"Michigan State's legendary coach continues to defy expectations with another deep run that proves East Lansing remains college basketball's most reliable program.",author:"Kyle Foster",time:"1d ago",readTime:"4 min",image:null,tags:["Michigan State","Izzo"],trending:true,views:29800},
];
...
function HomePage({dark,articles,bookmarks,toggleBookmark,onArticleClick,setPage}) {
  ...
  const featured=sorted.find(a=>a.hot&&a.staffPick&&a.team==="lions")||sorted.find(a=>a.hot&&a.staffPick)||sorted[0];
  // Don't exclude featured from sport sections — show full grids
  const proArts=sorted.filter(a=>["NFL","MLB","NBA","NHL"].includes(a.sport));
  ...
  const SH=({title,emoji,color,arts,id})=>(
    <div style={{marginBottom:42}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:13}}>
        {arts.map(a=><ArticleCard key={a.id} article={a} dark={dark} bookmarks={bookmarks} toggleBookmark={toggleBookmark} onClick={()=>onArticleClick(a)}/>)}
      </div>
    </div>
  );
