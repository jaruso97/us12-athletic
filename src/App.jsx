...
const ALL_ARTICLES = [
  {id:"l1",team:"lions",  sport:"NFL",title:"Lions Open as Super Bowl Favorites After Monster Offseason",excerpt:"Detroit's front office went all-in this summer, bringing in elite talent on both sides of the ball to complement Jared Goff's historic 2024 campaign.",author:"Marcus Johnson",time:"1h ago",readTime:"4 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Ford_Field_2007.JPG",tags:["Lions","NFL"],hot:true,trending:true,staffPick:true,views:62400},
  {id:"l2",team:"lions",  sport:"NFL",title:"Jared Goff Signs Historic Extension, Commits to Detroit Long-Term",excerpt:"After an MVP-caliber season, Goff and the Lions agree to a franchise-defining deal that cements Detroit as a sustained contender.",author:"Marcus Johnson",time:"3h ago",readTime:"3 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Aerial_View_of_Downtown_Detroit_-_Ford_Field_and_Comerica_Park.jpg",tags:["Lions","Goff"],staffPick:true,views:44100},
  {id:"t1",team:"tigers",  sport:"MLB",title:"Tarik Skubal Is the Best Pitcher in Baseball and It Isn't Close",excerpt:"With a sub-2.80 ERA and 200+ strikeouts already, Skubal has entered the conversation as the most dominant pitcher in all of baseball.",author:"Sarah Chen",time:"2h ago",readTime:"4 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Comerica_park_gate_D_entrance.JPG",tags:["Tigers","Skubal"],hot:true,trending:true,staffPick:true,views:58200},
  {id:"t2",team:"tigers",  sport:"MLB",title:"Tigers Young Core Has Every MLB Scout Raving About Detroit's Future",excerpt:"With Torkelson, Greene, and Skubal headlining, Detroit's rebuild has become the model every franchise wishes they'd executed.",author:"Sarah Chen",time:"5h ago",readTime:"3 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Comerica_park_ferris_wheel.JPG",tags:["Tigers","Rebuild"],staffPick:true,views:32700},
  {id:"p1",team:"pistons", sport:"NBA",title:"Cade Cunningham's MVP Campaign Is No Longer a Surprise",excerpt:"Detroit's franchise cornerstone is averaging 28-9-9 over his last 20 games. National media has finally caught up to what Michigan fans knew.",author:"Lisa Park",time:"2h ago",readTime:"4 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Detroit_December_2018_09_(Little_Caesars_Arena).jpg",tags:["Pistons","Cade"],trending:true,staffPick:true,views:41800},
  {id:"p2",team:"pistons", sport:"NBA",title:"Pistons Land All-Star Big in Blockbuster Trade to Pair with Cunningham",excerpt:"Detroit's front office pulled off a shocker that immediately vaults the Pistons into Eastern Conference title contention.",author:"Lisa Park",time:"6h ago",readTime:"5 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Detroit_December_2018_11_(Little_Caesars_Arena).jpg",tags:["Pistons","Trade"],hot:true,views:37200},
  {id:"rw1",team:"redwings",sport:"NHL",title:"Red Wings Playoff Push Is Real — Detroit Hockey Is Officially Back",excerpt:"Larkin and DeBrincat are putting together the best one-two punch in the Central. Little Caesars Arena hasn't been this loud in years.",author:"Tom Bradley",time:"3h ago",readTime:"4 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Detroit_December_2018_10_(Little_Caesars_Arena).jpg",tags:["Red Wings","Playoffs"],trending:true,staffPick:true,views:28900},
  {id:"rw2",team:"redwings",sport:"NHL",title:"Moritz Seider Named to NHL All-Star Game — Detroit's Rising Star Shines",excerpt:"Detroit's cornerstone defenseman earns his first All-Star nod after a dominant first half that draws comparisons to franchise legends.",author:"Tom Bradley",time:"8h ago",readTime:"3 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Detroit_December_2018_09_(Little_Caesars_Arena).jpg",tags:["Red Wings","Seider"],views:19400},
  {id:"um1",team:"michigan",sport:"CFB",title:"Michigan Football Enters Season Unanimous #1 in Both Major Polls",excerpt:"The Wolverines return 17 starters from last year's Big Ten championship. National media is already penciling them into the CFP final.",author:"Derek Williams",time:"4h ago",readTime:"5 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Ford_Field_2007.JPG",tags:["Michigan","CFB"],hot:true,trending:true,views:54300},
  {id:"um2",team:"michigan",sport:"CBB",title:"Wolverines Basketball Lands Top-Ranked Recruiting Class in Program History",excerpt:"Michigan secured three five-star commitments, vaulting Ann Arbor to the top of every national recruiting ranking heading into fall.",author:"Derek Williams",time:"1d ago",readTime:"4 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/United_Center,_Chicago.JPG",tags:["Michigan","Recruiting"],views:31100},
  {id:"ms1",team:"msu",    sport:"CFB",title:"Spartans Defense Ranked #1 Nationally After Dominant Spring Camp",excerpt:"Michigan State's rebuilt unit posted eye-popping numbers in spring practice, raising legitimate Big Ten title hopes.",author:"Kyle Foster",time:"6h ago",readTime:"3 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/2014_NHL_Stadium_Series,_Soldier_Field_Pano.JPG",tags:["Michigan State","Defense"],views:22600},
  {id:"ms2",team:"msu",    sport:"CBB",title:"Tom Izzo Masterclass: Spartans Return to Elite 8 in Another March Run",excerpt:"Michigan State's legendary coach continues to defy expectations with another deep run that proves East Lansing remains elite.",author:"Kyle Foster",time:"1d ago",readTime:"4 min",image:"https://commons.wikimedia.org/wiki/Special:FilePath/Wrigley_Field_Marquee_as_of_mid-2015.JPG",tags:["Michigan State","Izzo"],trending:true,views:29800},
];
...
const MERCH = [
  {id:"m1",name:"GLS Michigan Snapback",price:34.99,badge:"BESTSELLER",image:"https://picsum.photos/seed/gls_cap/600/600",colors:[NAVY,MAIZE,"#000"],category:"Headwear",rating:4.9,reviews:312},
  {id:"m2",name:"Lions × GLS Hoodie",price:69.99,badge:"NEW",image:"https://picsum.photos/seed/lions_gls/600/600",colors:[DET_BLUE,"#000"],sizes:["S","M","L","XL","2XL"],category:"Apparel",rating:4.8,reviews:124},
  {id:"m3",name:"Tigers × GLS Hoodie",price:69.99,badge:"HOT",image:"https://picsum.photos/seed/tigers_gls/600/600",colors:[DET_ORG,"#0C2340"],sizes:["S","M","L","XL","2XL"],category:"Apparel",rating:4.9,reviews:98},
  {id:"m4",name:"Pistons × GLS Tee",price:32.99,badge:null,image:"https://picsum.photos/seed/pistons_gls/600/600",colors:["#C8102E","#006BB6"],sizes:["S","M","L","XL"],category:"Apparel",rating:4.7,reviews:67},
  {id:"m5",name:"Red Wings × GLS Crewneck",price:59.99,badge:"LIMITED",image:"https://picsum.photos/seed/wings_gls/600/600",colors:["#CE1126","#000"],sizes:["S","M","L","XL"],category:"Apparel",rating:4.8,reviews:89},
  {id:"m6",name:"Michigan × GLS Premium Tee",price:34.99,badge:"NEW",image:"https://picsum.photos/seed/mich_gls/600/600",colors:[NAVY,MAIZE],sizes:["S","M","L","XL","2XL"],category:"Apparel",rating:4.6,reviews:45},
  {id:"m7",name:"GLS Logo Drinkware Set",price:49.99,badge:"BUNDLE",image:"https://picsum.photos/seed/gls_drink/600/600",colors:[NAVY,MAIZE],category:"Accessories",rating:4.9,reviews:201},
  {id:"m8",name:"Michigan State × GLS Hoodie",price:69.99,badge:null,image:"https://picsum.photos/seed/msu_gls/600/600",colors:["#18453B","#FFF"],sizes:["S","M","L","XL"],category:"Apparel",rating:4.7,reviews:56},
];
      ...
      <div style={{maxWidth:1400,margin:"0 auto",padding:"0 16px"}}>
        <div style={{display:"flex",alignItems:"center",gap:16,height:58}}>
          <div onClick={logoClick} style={{cursor:"pointer",flexShrink:0,userSelect:"none",display:"flex",alignItems:"center",gap:10}}>
            ...
            <div>
              <div className="hl" style={{fontSize:20,lineHeight:1}}><span style={{color:MAIZE}}>GREAT</span> LAKES</div>
              <div style={{fontSize:9,fontWeight:700,color:MAIZE,letterSpacing:"0.14em"}}>MICHIGAN SPORTS</div>
            </div>
          </div>
...
function ScoresPage({dark}) {
  ...
  const sports=["ALL","NFL","MLB","NBA","NHL"];const statuses=["ALL","LIVE","FINAL","UPCOMING"];
  const sc=sp=>({NFL:"#60a5fa",NBA:"#f87171",MLB:"#4ade80",NHL:"#a78bfa"}[sp]||tm);
  const filtered=scores.filter(s=>(sport==="ALL"||s.sport===sport)&&(status==="ALL"||s.status===status));
        ...
        <div style={{display:"flex",flexWrap:"wrap",gap:28,justifyContent:"space-between",marginBottom:28}}>
          <div>
            <div style={{display:"flex",alignItems:"center",gap:9,marginBottom:11}}>
              ...
              <div><div className="hl" style={{fontSize:18,color:"#fff"}}>GREAT LAKES SPORTS</div><div style={{fontSize:9,fontWeight:700,color:MAIZE,letterSpacing:"0.13em"}}>MICHIGAN SPORTS</div></div>
            </div>
